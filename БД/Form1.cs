...
namespace БД
{
    public partial class Form1 : Form
    {
        ...
        {
            string changestr = "INSERT INTO Tab VALUES (1, 2, 3, 4, 5, 6, 7)";
            OleDbCommand change = new OleDbCommand(changestr, connection);
